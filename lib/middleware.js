...
function matchJson(json) {
    return function() {
        this.deepEqual(this.responseJson, json, "Expected and actual JSON differ. Delta generated by json-diff: " + JSON.stringify(jsonDiff.diff(this.responseJson, json)));
        this.next();
    };
}
